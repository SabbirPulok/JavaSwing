...
public class CheckBoxItemListener extends JFrame {
	...
	public void initDemo()
	{
		...
		dhk.addItemListener(handler);
		ctg.addItemListener(handler);
		raj.addItemListener(handler);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		CheckBoxItemListener frame = new CheckBoxItemListener();
		frame.setVisible(true);
		frame.setTitle("CheckBoxItemListener");
